...
public class Done {
	...
	static Logger Log	= Logger.getLogger(Done.class);
 /**
 ...
 synchronized public void  incProcessingThreads()
 {
	 processingThreads++;
 }
 synchronized public void  decrProcessingThreads()
 {
	 processingThreads --;
	 
 }
 synchronized public int  getProcessingThreads()
 {
	 //Log.info(" Processing threads count==="+processingThreads);
